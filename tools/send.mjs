...
function email(token) {
  ...
  const paras = [
    ...
    'we will never act like adobe. they made cancelling so hard that the USA government took them to court over it. i think that\'s disgusting, so i built something else.',
